...
public interface BaUserRepository extends JpaRepository<BaUser, String> {
    ...
    List<BaUser> findByStatut(EStatut statut);
    List<BaUser> findByFonctionAndStatut(EFonctionEmploye fonction, EStatut statut);
    List<BaUser> findByFonctionAndDepartementIdAndStatut(EFonctionEmploye fonction, String departementId, EStatut statut);
    List<BaUser> findByFonctionAndServiceIdAndStatut(EFonctionEmploye fonction, String serviceId, EStatut statut);
    List<BaUser> findByFonctionAndAgenceIdAndStatut(EFonctionEmploye fonction, String agenceId, EStatut statut);

    boolean existsByMatricule(String matricule);

    List<BaUser> findByNomContainingIgnoreCaseOrPrenomContainingIgnoreCaseOrMatriculeContainingIgnoreCaseOrTelephoneFixeContainingIgnoreCaseOrTelephoneMobileContainingIgnoreCase(
            String nom,
            String prenom,
            String matricule,
